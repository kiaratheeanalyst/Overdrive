...
#pragma warning restore CS0168 // Variable is declared but never used
        ...
        private void OnDestroy()
        {
            if (m_Controller != null)
            {
                if (!(m_Controller.CompareKeyValueEquality(m_Controller.GetSettingsList(),
                          m_Controller.GetLastCachedKeyList()) &&
                      m_Controller.CompareRulesEquality(m_Controller.GetRulesList(),
        ...
        private void DrawEnvironmentDropdown(float currentY)
        {
            ...
            GUIContent ddBtnContent = new GUIContent(Regex.Replace(m_Controller.GetCurrentEnvironmentName(), @"[/]+", "\u2215"));
        ...
        private void CreateRuleTypeDropdown(string labelText, JObject rule, float currentY, Rect configPaneRect, float labelWidth = 115f)
        {
        ...
        private string CreateLabelAndTextField(string labelText, string textFieldText, float currentY, Rect configPaneRect, float labelWidth = 115f)
        {
            var labelX = configPaneRect.x + 5;
            var textFieldX = labelX + labelWidth + 5;
            var textFieldWidth = configPaneRect.width - labelWidth - 15;
