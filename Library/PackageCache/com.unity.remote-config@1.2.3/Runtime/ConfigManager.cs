...
namespace Unity.RemoteConfig
{
    ...
    public static class ConfigManager
    {
        ...
        static Common commonPayload;
        static DeviceInfo deviceInfoPayload;

        internal static event Action<ConfigResponse, JObject> ResponseParsed;
        internal static event Action<ConfigOrigin, Dictionary<string, string>, string> RawResponseReturned;
        internal static event Action<ConfigOrigin, Dictionary<string, string>, string> RawResponseValidated;

        static List<Func<JObject>> requestPayloadProviders = new List<Func<JObject>>();
        static List<Func<RequestHeaderTuple>> requestHeaderProviders = new List<Func<RequestHeaderTuple>>();
        static List<Func<Dictionary<string, string>, string, bool>> rawResponseValidators = new List<Func<Dictionary<string, string>, string, bool>>();
        ...
        /// <summary>
        /// Sets environment identifier in the Remote Config delivery request payload.
        /// </summary>
        ...
        public static void FetchConfigs(object userAttributes, object appAttributes)
        {
            PostConfig(userAttributes, appAttributes);
        }
        ...
        static JObject CreatePayloadJObjectFromValuesJObject(JObject jObject, string type, long ts)
        {
            jObject.Add("ts", ts);
        ...
        static void ToNewlineDelimitedJson<T>(Stream stream, IEnumerable<T> items)
        {
        ...
        static void ToNewlineDelimitedJson<T>(TextWriter textWriter, IEnumerable<T> items)
        {
        ...
        internal static void AddRequestPayloadProvider(Func<JObject> provider)
        {
            requestPayloadProviders.Add(provider);
        }

        internal static void RemoveRequestPayloadProvider(Func<JObject> provider)
        {
            requestPayloadProviders.Remove(provider);
        }

        internal static void AddRequestHeaderProvider(Func<RequestHeaderTuple> provider)
        {
            requestHeaderProviders.Add(provider);
        }

        internal static void RemoveRequestHeaderProvider(Func<RequestHeaderTuple> provider)
        {
            requestHeaderProviders.Remove(provider);
        }

        internal static void AddRawPayloadValidatorFunc(Func<Dictionary<string, string>, string, bool> validatorFunc)
        {
            rawResponseValidators.Add(validatorFunc);
        }

        internal static void RemoveRawPayloadValidatorFunc(Func<Dictionary<string, string>, string, bool> validatorFunc)
        {
